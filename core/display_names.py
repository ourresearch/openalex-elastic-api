...
DISPLAY_NAME_OVERRIDES: Dict[str, Dict[str, dict]] = {
    ...
    'sources': {
        ...
        'listed_in': {"display_name": 'listed in'},
    ...
    'works': {
        ...
        'primary_location.source.listed_in': {"display_name": 'source listed in'},
...
_THREAD_B_OVERRIDES: Dict[str, Dict[str, dict]] = {
    'works': {
        ...
        'locations.source.listed_in': {"display_name": 'any location source listed in'},
        'best_oa_location.source.listed_in': {"display_name": 'best OA source listed in'},
