...
# 5.0.0 (#430 deprecate default.search): `default.search` was a per-entity footgun name — on works
...
# the `text.search` name 2026-06-14 (oxjobs #430). Same MAJOR rationale as 2.0.0/3.0.0 (a top-level
# catalog entry is removed). = MAJOR.
