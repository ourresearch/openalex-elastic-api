...
fields = [
    ...
    SearchField(param="text.search", index="licenses"),
    SearchField(param="default.search", index="licenses", alternate_of="text.search"),
    SearchField(
    ...
    CollectionField(entity_type="licenses"),
]
