...
# The 26 entity types shipped in config/*.yaml (one file each).
...
CLOSED_VOCAB = {
    ...
    "source-lists", "source-types", "study-designs", "subfields", "work-types",
}


def test_all_26_entities_present():
    assert len(ALL_ENTITIES) == 26, ALL_ENTITIES
