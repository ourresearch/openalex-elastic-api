...
DOCSTRINGS = {
    "openalex": "The OpenAlex ID for the institution type",
}
...
fields = [
    ...
    SearchField(param="text.search", index="types"),
    SearchField(param="default.search", index="types", alternate_of="text.search"),
    SearchField(
