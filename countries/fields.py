...
fields = [
    ...
    SearchField(param="text.search", index="countries"),
    SearchField(param="default.search", index="countries", alternate_of="text.search"),
    SearchField(
    ...
    CollectionField(entity_type="countries"),
]
