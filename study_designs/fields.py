...
DOCSTRINGS = {
    "openalex": "The OpenAlex ID for the study design",
}

# shared documentation_links for when multiple fields share the same link (such as aliases)
DOCUMENTATION_LINKS = {
    "openalex": "https://help.openalex.org/data/study-designs/",
}
...
fields = [
    ...
    SearchField(
        ...
        docstring="Free text search among study designs' names",
        documentation_link="https://developers.openalex.org/guides/searching",
    ),
    TermField(param="display_name", custom_es_field="display_name.keyword"),
    CollectionField(entity_type="study-designs"),
]
