...
Queries are limited to between 20 and 2000 characters. The endpoint is rate limited to 1 request per second. Each request costs $0.01 (see [rate limits](../how-to-use-the-api/rate-limits-and-authentication.md)).
